        ...
        <div class="absolute top-5 right-5 z-20">
            ...
            <ct-card :visible="state.picked.id" @close="onClose" class="mb-5">
                ...
                <div class="flex items-center py-4 border-b-2">
                    ...
                    <p class="ml-4 text-sm">Aktualny stopień zalesienia: <span class="font-semibold">30%</span></p>
                </div>
                <div class="flex items-center py-4 border-b-2">
            ...
            <ct-card :visible="state.pickedTree.id" @close="onClose">
                ...
                <div class="flex items-center py-4 border-b-2">
                    <img class="w-6 h-6" src="../../assets/icons/co2.png" />
                    <p class="ml-4 text-sm">Stopień wpływu CO2: 10<span class="text-red-500 font-semibold">(-2)</span></p>
                </div>
                <div class="flex items-center py-4 border-b-2">
                    <img class="w-6 h-6" src="../../assets/icons/temperature.png" />
                    <p class="ml-4 text-sm">Temperatura: <span class="text-red-500 font-semibold">35</span></p>
                </div>
                <div class="flex items-center py-4">
                    <img class="w-6 h-6" src="../../assets/icons/nature.png" />
                    <p class="ml-4 text-sm">Stopień zalesienia po wycince: 27%<span class="text-red-500 font-semibold">(-3%)</span></p>
                </div>
            </ct-card>
        </div>
  </div>
...
onMounted(() => {
    ...
    L.tileLayer('https://tiles.stadiamaps.com/tiles/osm_bright/{z}/{x}/{y}{r}.png').addTo(map.value as L.Map);
...
watch(() => state.searchInput, (newInput:any) => {
    if(newInput !== ''){
